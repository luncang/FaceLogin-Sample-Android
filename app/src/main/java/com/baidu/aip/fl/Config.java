...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "EfpCtSxgL17bSNHvYuUGGSDi";
    public static String secretKey = "GFXpO5oUP00CG9dnGeZVxnSzs9H3dLf7";
    public static String licenseID = "luncang19880927-face-android";
     ...
     */
    public static String groupID = "test123";
